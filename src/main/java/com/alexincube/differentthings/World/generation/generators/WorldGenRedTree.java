...
{
    public static final IBlockState DARK_OAK_LOG = BlocksRegister.REDLOGS.getDefaultState();
    public static final IBlockState DARK_OAK_LEAVES = BlocksRegister.REDLEAVES.getDefaultState();

    private final int minHeight;

    public WorldGenRedTree()
    {
        super(false);
        this.minHeight = 8;
    }
