package com.alexincube.differentthings.World.generation;
...
{
    private final WorldGenerator COPPER = new WorldGenRedTree();
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
    {
        switch(world.provider.getDimension())
        {
            ...
            case 0:
                runGenerator(COPPER, world, random, chunkX, chunkZ, 5, Blocks.GRASS, BiomePlains.class);
