...
public class GuiRepairer extends GuiContainer {
    ...
    private final TileEntityRepairer te;

    public GuiRepairer(InventoryPlayer playerInventory, TileEntityRepairer chestInventory, EntityPlayer player){
        super(new ContainerRepairer(playerInventory,chestInventory,player));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (mouseX > guiLeft+37 && mouseX < guiLeft+139 && mouseY > guiTop+57 && mouseY < guiTop+65){
            drawHoveringText(Collections.singletonList("Energy: "+energy+"/"+TileEntityRepairer.MAX_POWER),mouseX,mouseY,fontRenderer);
        }
    }
    ...
    private void drawEnergyBar(int energy){
        ...
        drawRect(guiLeft+38,guiTop+58,guiLeft+38+((energy*100/TileEntityRepairer.MAX_POWER)),guiTop+64, 0xffff0000);
