...
public class TileEntityDiamondFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.DIAMONDfurnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            this.cooktimemultiplier= (int) (50-(50*(cooktimecostup1+cooktimecostup2+cooktimecostup3)));
            ...
            {
                flag1 = true;
                BlockDiamondFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemstack = this.furnaceItemStacks.get(1);
            return isItemFuel(stack) || SlotDiamondFurnaceFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
        }
    }
    ...
    {
        return String.valueOf(DifferentThings.GUI_DIAMOND_FURNACE);
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerDiamondFurnace(playerInventory, this);
    }
