...
public class BlockBreaker extends BlockContainer {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ){
        if(!worldIn.isRemote){
            playerIn.openGui(DifferentThings.instance, DifferentThings.GUI_BREAKER, worldIn, pos.getX(),pos.getY(),pos.getZ());
        }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityBreaker tileentity = (TileEntityBreaker)worldIn.getTileEntity(pos);
