...
public class BlockRepairer extends BlockContainer {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ){
        if(!worldIn.isRemote){
            playerIn.openGui(DifferentThings.instance, DifferentThings.GUI_REPAIRER, worldIn, pos.getX(),pos.getY(),pos.getZ());
        }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityRepairer tileentity = (TileEntityRepairer)worldIn.getTileEntity(pos);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        if(stack.hasDisplayName()){
            ...
            if(tileEntity instanceof TileEntityRepairer){
                ((TileEntityRepairer)tileEntity).setCustomName(stack.getDisplayName());
            }
        }
    }
