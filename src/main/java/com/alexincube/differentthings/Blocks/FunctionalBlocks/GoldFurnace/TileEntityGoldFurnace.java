...
public class TileEntityGoldFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private float fuelcostmultiplier;
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.Goldfurnace";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityGoldFurnace.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            float fuelcostup2 = 0;
            float fuelcostup3 = 0;
            double cooktimecostup1 = 0;
            double cooktimecostup2 = 0;
            double cooktimecostup3 = 0;
            ...
            if (upgrade.getItem() instanceof ItemFurnaceCookTimeUpgrade){
                ItemFurnaceCookTimeUpgrade itemUpgrade = (ItemFurnaceCookTimeUpgrade) upgrade.getItem();
                cooktimecostup1=itemUpgrade.getcooktimemultiplier();
            }
            ...
            if (upgrade2.getItem() instanceof ItemFurnaceCookTimeUpgrade){
                ItemFurnaceCookTimeUpgrade itemUpgrade = (ItemFurnaceCookTimeUpgrade) upgrade2.getItem();
                cooktimecostup2=itemUpgrade.getcooktimemultiplier();
            }
            ...
            if (upgrade3.getItem() instanceof ItemFurnaceCookTimeUpgrade){
                ItemFurnaceCookTimeUpgrade itemUpgrade = (ItemFurnaceCookTimeUpgrade) upgrade3.getItem();
                cooktimecostup3=itemUpgrade.getcooktimemultiplier();
            }


            this.cooktimemultiplier= (int) (120-(120*(cooktimecostup1+cooktimecostup2+cooktimecostup3)));
            this.fuelcostmultiplier=1+(1*(fuelcostup1+fuelcostup2+fuelcostup3));

            if (this.isBurning() || !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty())
            {
                if (!this.isBurning() && this.canSmelt())
                {
                    this.furnaceBurnTime = (int) (getItemBurnTime(itemstack)*this.fuelcostmultiplier);
            ...
            {
                flag1 = true;
                BlockGoldFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemstack = this.furnaceItemStacks.get(1);
            return isItemFuel(stack) || SlotGoldFurnaceFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
        }
    }
    ...
    {
        return String.valueOf(DifferentThings.GUI_GOLD_FURNACE);
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerGoldFurnace(playerInventory, this);
    }
    ...
    public int getField(int id)
    {
        switch (id)
        {
            ...
            case 4:
                return (int) this.fuelcostmultiplier;
            case 5:
                return this.cooktimemultiplier;
            default:
                return 0;
    ...
    public void setField(int id, int value)
    {
        switch (id)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                this.fuelcostmultiplier = value;
                break;
            case 5:
                this.cooktimemultiplier = value;
                break;
        }
    }
