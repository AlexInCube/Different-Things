...
public class TileEntityIronFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(com.alexincube.differentthings.Blocks.FunctionalBlocks.IronFurnace.TileEntityIronFurnace.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            this.cooktimemultiplier= (int) (170-(170*(cooktimecostup1+cooktimecostup2+cooktimecostup3)));
