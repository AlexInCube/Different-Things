...
public class ContainerBreaker extends Container {
    ...
    private final TileEntityBreaker chestInventory;
    private int energy;

    public ContainerBreaker(InventoryPlayer playerInv, TileEntityBreaker TileEntityBreaker, EntityPlayer player){
        this.chestInventory = TileEntityBreaker;
        TileEntityBreaker.openInventory(player);


        this.addSlotToContainer(new Slot(TileEntityBreaker, 0, 80 , 38));
    ...
    public TileEntityBreaker getChestInventory() {
