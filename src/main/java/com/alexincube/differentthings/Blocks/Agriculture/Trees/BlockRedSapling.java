...
import com.alexincube.differentthings.World.generation.generators.WorldGenRedTree;
...
public class BlockRedSapling extends BlockBush implements IGrowable
{
    public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);
    protected static final AxisAlignedBB SAPLING_AABB = new AxisAlignedBB(0.09999999403953552D, 0.0D, 0.09999999403953552D, 0.8999999761581421D, 0.800000011920929D, 0.8999999761581421D);


    public BlockRedSapling(String name)
    {
    ...
    public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
    {
        ...
        WorldGenerator gen = (WorldGenerator)(rand.nextInt(5) == 0 ? new WorldGenBigTree(false) : new WorldGenTrees(false));
        boolean flag = false;
        int i = 0, j = 0;


        gen = new WorldGenRedTree();
    ...
    {
        return (double)worldIn.rand.nextFloat() < 1D;
